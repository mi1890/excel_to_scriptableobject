...
namespace GreatClock.Common.ExcelToSO
{
    ...
    public class ExcelToScriptableObject : EditorWindow
    {
        ...
        private struct GenerateCodeSettings
        {
            ...
            public bool add_custom_attribute;
            public string custom_attribute_name;
        }
        ...
        static bool GenerateCode(GenerateCodeSettings settings)
        {
            ...
            if (settings.add_custom_attribute)//add custom attribute to exsit
            {
                serializeAttribute = settings.hide_asset_properties ? "[SerializeField, HideInInspector, " + settings.custom_attribute_name + "]" : "[SerializeField, " + settings.custom_attribute_name + "]";
            }
            ...
            foreach (SheetData sheet in sheets)
            {
                ...
                content.AppendLine(string.Format("{0}public partial class {1} {{", indent, sheet.itemClassName));
                content.AppendLine();
        ...
        private class ExcelToScriptableObjectSettingWrap
        {
            ...
            {
                return (EditorGUIUtility.singleLineHeight + EditorGUIUtility.standardVerticalSpacing) * 8 + 4f + mSlavesList.GetHeight();
            }
            public void DrawGUI(Rect rect, bool isActive, bool isFocused, ToProcess toProcess)
            {
                ...
                pos.x += pos.width;
                mSetting.base_class = EditorGUI.TextField(pos, "BaseClass", mSetting.base_class);
                ...
                pos.y += pos.height + EditorGUIUtility.standardVerticalSpacing;
                mSetting.add_custom_attribute = EditorGUI.ToggleLeft(pos, "Add Custom Attribute", mSetting.add_custom_attribute);
        ...
        static GenerateCodeSettings GetGenerateCodeSetting(ExcelToScriptableObjectSetting setting)
        {
            ...
            ret.base_class = setting.base_class;
            ...
            ret.add_custom_attribute = setting.add_custom_attribute;
            ret.custom_attribute_name = setting.custom_attribute_name;
            return ret;
        }
